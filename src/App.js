  ...
  render() {
    return (
      <div className="App">
        ...
        <UserOutput paragraph1={this.state.userOutputs[0].paragraph1} paragraph2={this.state.userOutputs[0].paragraph2} />
        <UserOutput paragraph1={this.state.userOutputs[1].paragraph1} paragraph2={this.state.userOutputs[1].paragraph2} />
        <UserOutput paragraph1={this.state.userOutputs[2].paragraph1} paragraph2={this.state.userOutputs[2].paragraph2} />
      </div>
    );
  }
}
